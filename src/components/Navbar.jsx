...
const Navbar = () => {
  ...
  const navLinks = user?.email ? (
    <>
      ...
      <NavLink to="/find-partners" className={navStyle}>Find Partners</NavLink>
  ...
  function navStyle({ isActive }) {
    return `font-semibold px-3 py-2 rounded-md transition ${
      isActive
  ...
  return (
    <nav className="bg-white shadow-md sticky top-0 z-[999] backdrop-blur-md  ">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          <Link to="/" className="flex items-center gap-2">
            ...
            <h1 className="text-xl font-extrabold text-green-700">StudyMate</h1>
          </Link>
          ...
          <div className="flex items-center gap-3">
            ...
            {user?.email ? (
              <div className="relative group hidden md:block">
                ...
                <div className="absolute right-0 mt-3 w-52 bg-white shadow-lg rounded-xl opacity-0 group-hover:opacity-100 scale-95 group-hover:scale-100 transition-all p-3">
